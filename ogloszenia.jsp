        ...
        <div class="blok">
            ...
            <ul>
                ...
                <li>
                    ...
                    <form action="deleteOgloszenie" method="post" style="display:inline;"
                    ...
                    <div id="edit-<%= id %>" style="display:none; margin-top:8px;">
                        <form action="editOgloszenie" method="post" enctype="multipart/form-data">
                    ...
                    <% if (user != null) { %>
                    <form action="addComment" method="post" style="margin-left:20px;">
                        <input type="hidden" name="id" value="<%= id %>">
            ...
            <% if (user != null) { %>
            <form action="addOgloszenie" method="post" enctype="multipart/form-data">
